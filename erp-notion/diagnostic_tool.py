...
class DiagnosticTool:
    ...
    def generate_recommendations(self):
        ...
        if warning_count > 0:
            recommendations.append("⚠️ Revisar advertencias para mejorar funcionamiento")
        ...
        for test in failed_tests:
            if "Conexión Notion API" in test["test"]:
                ...
                recommendations.append("🗄️ Verificar IDs de bases de datos y permisos")
    ...
    def print_summary(self):
        ...
        print(f"⚠️ Advertencias: {warned_tests}")
        
        if failed_tests == 0:
            print("\n🎉 ¡Todas las pruebas críticas pasaron!")
        else:
            print(f"\n🚨 {failed_tests} pruebas fallidas requieren atención")
