#!/usr/bin/env python3
"""
Servidor ultra-simple para dashboard con Notion
"""
...
# IDs de bases de datos (CORRECTOS)
...
class DashboardHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def get_notion_metrics(self):
        ...
        try:
            ...
            cxc_response = requests.post(cxc_url, headers=headers, json={"page_size": 50})
            metrics["api_calls"] += 1
        ...
        try:
            ...
            cxp_response = requests.post(cxp_url, headers=headers, json={"page_size": 50})
            metrics["api_calls"] += 1
        ...
        try:
            ...
            projects_response = requests.post(projects_url, headers=headers, json={"page_size": 50})
            metrics["api_calls"] += 1
