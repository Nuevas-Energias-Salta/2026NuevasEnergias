...
def main():
    print("=" * 60)
    print("⚠️  LIMPIEZA COMPLETA DE BASES DE DATOS")
    print("=" * 60)
    
    print("\n🚨 ADVERTENCIA:")
    print("   Esto eliminará TODOS los datos de:")
    for name in DATABASES.keys():
        print(f"   - {name}")
    
    print("\n¿Estás SEGURO de continuar? (escribe 'SI ELIMINAR TODO')")
    confirmacion = input("> ")
    ...
    print("=" * 60)
    print("\nTodas las bases de datos están vacías.")
